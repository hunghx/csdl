...
CREATE TABLE `sanpham` (
  ...
  `maloaisp` varchar(5) DEFAULT NULL,
...
INSERT INTO `sanpham` VALUES ('SP01','LSP1','iPhone 12','cái','Màu đen, bộ nhớ 128GB'),('SP02','LSP1','Samsung Galaxy S21','cái','Màu xanh, bộ nhớ 256GB'),('SP03','LSP2','Dell XPS 13','cái','Core i7, RAM 16GB'),('SP04','LSP2','IP14','cais','ios16');
